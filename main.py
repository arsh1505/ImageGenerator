...
generator_button = ctk.CTkButton(input_frame,text="Generate",command=generate)
generator_button.grid(row=3,column=0, columnspan=2,sticky="news", padx=10,pady=10)
